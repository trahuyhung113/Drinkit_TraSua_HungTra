...
import com.example.hungtra.drinkit_trasua.OrderDetailActivity;
...
public class OrderAdapter extends RecyclerView.Adapter<OrderViewHolder> {
    ...
    public void onBindViewHolder(@NonNull OrderViewHolder orderViewHolder, final int i) {
        ...
        orderViewHolder.txt_order_status.setText(new StringBuilder("Order Status: ")
                .append(Common.convertCodeToStatus(orderList.get(i).getOrderStatus())));
